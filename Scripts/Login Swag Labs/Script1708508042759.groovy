...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs (1)/div_Sauce Labs Backpack'), 10)

WebUI.click(findTestObject('Object Repository/Page_Swag Labs (1)/div_Sauce Labs Backpack'))
